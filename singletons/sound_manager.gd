...
const SOUND_UNLOCK_DOOR = "unlock_door"
const SOUND_UNLOCK_CHEST = "unlock_chest"
...
var SOUNDS: Dictionary = {
	...
	SOUND_UNLOCK_DOOR: preload("res://assets/sounds/sfx/512139__beezlefm__unlock-sound.wav"),
	SOUND_UNLOCK_CHEST: preload("res://assets/sounds/sfx/puff-of-magic-treasure-chest-light-smartsound-fx-1-00-04.mp3"),
